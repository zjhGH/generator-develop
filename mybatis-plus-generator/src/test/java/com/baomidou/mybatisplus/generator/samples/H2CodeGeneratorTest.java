...
public class H2CodeGeneratorTest extends BaseGeneratorTest {
    ...
    @Test
    public void testSimpleNdy() {
        AutoGenerator generator = new AutoGenerator(new DataSourceConfig
            .Builder("jdbc:postgresql://47.101.148.107:9432/ndy_new", "postgres", "123!Feiwei")
...
//            .addInclude("ndy_model_form,ndy_model")//添加表名
            .addInclude("ndy_model")
            .addTablePrefix("ndy_")//过滤字段名前缀
